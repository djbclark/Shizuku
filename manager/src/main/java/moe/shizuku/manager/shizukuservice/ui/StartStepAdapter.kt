...
class StartStepAdapter : ListAdapter<StartStep, StartStepAdapter.ViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemStartStepBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    class ViewHolder(private val binding: ItemStartStepBinding) : RecyclerView.ViewHolder(binding.root) {
